...
SCHEMA_INIT = """
    INSERT INTO profinet_device VALUES ('DIO8',   1, 2);
    INSERT INTO profinet_device VALUES ('DIO64',    1, 3.3);
    INSERT INTO profinet_device VALUES ('DIO128',   1, 6.45);
"""
...
def main(): 
    ...
    state._set(("TestValue", 1), 7)
    print(state._get(("TestValue", 1)))
