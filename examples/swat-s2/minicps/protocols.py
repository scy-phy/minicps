...
class PnioProtocol(Protocol):
    ...
    def __init__(self, protocol):
        ...
        self._db_path = "./profinet_states/profinet_device_" +  self._server['name'] + "-" + random.randint(1, 10000000000) + ".sqlite"
    ...
    @classmethod
    def _start_server(cls, address, tags, device, db_path):
        """Start a cpppo enip server.
