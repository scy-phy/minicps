...
#define APP_GSDML_INPUT_DATA_SIZE_4   4 /* bytes, for digital inputs data */
#define APP_GSDML_OUTPUT_DATA_SIZE_4  4 /* bytes, for digital outputs data */
#define APP_GSDM_ALARM_PAYLOAD_SIZE_4 1 /* bytes */
