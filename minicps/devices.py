...
# Physical enviroment simulation
class ControlDevice(pykka.ThreadingActor):
    """Docstring for ControlDevice. """

    def __init__(self, memory):
        super(ControlDevice, self).__init__()
        """
        :memory: path to the file
        """
    ...
    def on_receive(self, message):
        ...
        :returns: answer or None (implicit or explicit)
        """

        # Exceptions are passed to the message sender
        if message['msg'] == 'ABORT':
            ...
            if cdm == 'append':
                ...
                self.write(message['data'], message['key'])

    def append(self, data):
        """
        TODO
        """
        logger.debug("%s.xml: append %s" % (self.memory, data))

    def write(self, data, key):
        """
        TODO write or overwrite a sample
        """
        pass
    ...
    def read_last(self):
        """
        TODO read last sample
        """
        pass

    def read_sample(self, key):
        """
        TODO read key sample
        """
        pass

    def reset(self):
        """
        TODO reset memory file
        """
        pass


class FlowSensor(ControlDevice):

    """Docstring for FlowSensor. """

    def __init__(self, memory, flow_level=0.0):
        """TODO: to be defined1. """
        ControlDevice.__init__(self, memory)

        self.flow_level = flow_level


class MotorizedValve(ControlDevice):

    """Docstring for MotorizedVale. """

    def __init__(self, memory, is_open=False):
        """TODO: to be defined1. """
        ControlDevice.__init__(self, memory)
...
class PLCLogic1(ControlDevice):

    """Docstring for PLCLogic1. """
...
class SWATSub1(ControlDevice):

    """Docstring for SWaT subprocess 1. """
